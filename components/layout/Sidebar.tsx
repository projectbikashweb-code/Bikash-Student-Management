...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-50 h-[100dvh] bg-[#1e2235] flex flex-col transition-transform lg:transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] shadow-2xl',
      ...
      >
        ...
        <div className="border-t border-white/10 p-3 space-y-2">
          ...
          <button
            ...
            className="hidden lg:flex items-center gap-2 w-full px-3 py-1.5 rounded-lg text-xs text-white/30 hover:text-white/60 transition-all"
          >
